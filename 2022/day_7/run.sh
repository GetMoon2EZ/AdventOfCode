...
mkdir -p build
gcc -g -Wall src/main.c -o build/advent_of_code
...
./build/advent_of_code 1 control_input.txt
printf "\n${LCYAN}# CHALLENGE 2${NC}\n"
./build/advent_of_code 2 control_input.txt

printf "\n${LRED}--------------- TEST CASE: input.txt ---------------${NC}\n"
printf "${LCYAN}# CHALLENGE 1${NC}\n"
./build/advent_of_code 1 input.txt
printf "\n${LCYAN}# CHALLENGE 2${NC}\n"
./build/advent_of_code 2 input.txt
