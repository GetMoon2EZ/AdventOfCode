<main>
<article class="day-desc"><h1>--- Day 18: Boiling Boulders ---</h1><h2>--- Part One ---</h2><p>You and the elephants finally reach fresh air. You've emerged near the base of a large volcano that seems to be actively erupting! Fortunately, the lava seems to be flowing away from you and toward the ocean.</p>
