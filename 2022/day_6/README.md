<main>
<article class="day-desc"><h1>--- Day 6: Tuning Trouble ---</h1><h2>--- Part One ---</h2><p>The preparations are finally complete; you and the Elves leave camp on foot and begin to make your way toward the <em class="star">star</em> fruit grove.</p>
