<main>
<article class="day-desc"><h1>--- Day 10: Syntax Scoring ---</h1><h2>--- Part One ---</h2><p>You ask the submarine to determine the best route out of the deep-sea cave, but it only replies:</p>
