<main>
<article class="day-desc"><h1>--- Day 7: The Treachery of Whales ---</h1><h2>--- Part One ---</h2><p>A giant <a href="https://en.wikipedia.org/wiki/Sperm_whale" target="_blank">whale</a> has decided your submarine is its next meal, and it's much faster than you are. There's nowhere to run!</p>
